...
export function IntegrationsClient({ googleConnected, slackConnected, hubspotConnected, notionConnected }: { googleConnected: boolean; slackConnected: boolean; hubspotConnected: boolean; notionConnected: boolean }) {
              ...
              <div className="w-full space-y-4">
                ...
                <div className="flex items-center justify-between p-5 rounded-2xl bg-[#f8f9fa] border border-gray-100 hover:border-gray-200 hover:bg-gray-50 transition-all">
                  <div>
                    ...
                    <div className="text-[13px] text-gray-500 mt-1 font-medium">Messages · Channels · Search</div>
                  </div>
                  {slackConnected ? (
                    <span className="text-xs font-bold px-3 py-1.5 rounded-full bg-green-100 text-green-700 border border-green-200 shadow-sm">
                      Connected
                    ...
                    <a
                      ...
                      className="text-[13px] font-bold px-5 py-2.5 rounded-xl bg-[#4A154B] hover:bg-[#611f69] text-white shadow-md shadow-purple-900/20 transition-all active:scale-95"
                    >
                      Connect
                    </a>
                  )}
                ...
                <div className="flex items-center justify-between p-5 rounded-2xl bg-[#f8f9fa] border border-gray-100 hover:border-gray-200 hover:bg-gray-50 transition-all">
                  <div>
                    ...
                    <div className="text-[13px] text-gray-500 mt-1 font-medium">Pages · Databases · Blocks</div>
                  </div>
                  {notionConnected ? (
                    <span className="text-xs font-bold px-3 py-1.5 rounded-full bg-green-100 text-green-700 border border-green-200 shadow-sm">
                      Connected
                    ...
                    <a
                      href="/api/integrations/notion/auth"
                      className="text-[13px] font-bold px-5 py-2.5 rounded-xl bg-[#000000] hover:bg-[#333333] text-white shadow-md shadow-black/20 transition-all active:scale-95"
                    >
                      Connect
                    </a>
                  )}
